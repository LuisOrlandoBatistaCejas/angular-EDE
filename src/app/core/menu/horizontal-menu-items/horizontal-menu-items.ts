        ...
        children: [
            {
                ...
                icon: 'explore',
                children: [
                    {state: 'saas', type: 'link', name: 'SAAS'},
                    {state: 'web-analytics', type: 'link', name: 'WEB ANALYTICS'}
                ]
            },
            {
                state: 'courses',
            ...
            },
            {
                ...
                icon: 'explore',
                children: [
                    {state: 'shop', type: 'link', name: 'SHOP'},
                    {state: 'cart', type: 'link', name: 'CART'},
                    {state: 'checkout', type: 'link', name: 'CHECKOUT'},
                    {state: 'cards', type: 'link', name: 'CARDS'},
                    {state: 'invoice', type: 'link', name: 'INVOICE'}
                ]
            },
            {
                state: 'inbox',
